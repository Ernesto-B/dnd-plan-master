(function () {
  const ICONS = {
    ...
    settings: '<circle cx="12" cy="12" r="3.2"></circle><path d="M12 4.5v2.2M12 17.3v2.2M4.5 12h2.2M17.3 12h2.2M6.4 6.4l1.6 1.6M16 16l1.6 1.6M17.6 6.4L16 8M8 16l-1.6 1.6"></path>',
